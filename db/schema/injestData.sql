...
values 
    ('sumo',4,'medium','first level','{"numLevels":1,"levels":[]}',1,CURRENT_TIMESTAMP - INTERVAL '5 days'),
    ('titan',5,'easy','begin','{"numLevels":2,"levels":[]}',2,CURRENT_TIMESTAMP - INTERVAL '10 days'),
    ('cryptic',3,'medium','confusing','{"numLevels":1,"levels":[]}',3,CURRENT_TIMESTAMP - INTERVAL '15 days'),
    ('breeze',4,'hard','you shall not pass','{"numLevels":5,"levels":[]}',1,CURRENT_TIMESTAMP - INTERVAL '20 days'),
    ('heaven',4,'easy','easy','{"numLevels":1,"levels":[]}',4,CURRENT_TIMESTAMP - INTERVAL '25 days');
